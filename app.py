...
if not OPENAI_API_KEY:
    print("⚠️ WARNING: Missing OPENAI_API_KEY in environment variables!")
if not DISCORD_WEBHOOK_URL:
    print("⚠️ WARNING: Missing DISCORD_WEBHOOK_URL in environment variables!")
...
# Vercel serverless function handler (WSGI app variable)
# This variable is required for Vercel's Python runtime
